...
var Layout = function (_ContinuousLayout) {
  ...
  _createClass(Layout, [{
    ...
    value: function prerun() {
      ...
      var sbgnLayout = this.sbgnLayout = new SBGNLayout();
      var graphManager = this.graphManager = sbgnLayout.newGraphManager();
      ...
      var polishingInfo = sbgnLayout.addPerComponentPolishingConstraints(components, directions);
